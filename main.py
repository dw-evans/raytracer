...
spheres = [
    ...
    Sphere(
        ...
        pos=Vector3((1.5, 2, 3), dtype="f4"),
        radius=1.5,
        material=material_light_source_1,
    ),
    Sphere(
        pos=Vector3((0, 1, 7), dtype="f4"),
        radius=0.5,
        material=material_plain_1,
    ),
]
...
triangles = [
    ...
    Triangle(
        Vector3((-1, -0.8, 3), dtype="f4"),
        Vector3((-1, -0, 8), dtype="f4"),
        Vector3((1, -0.8, 3), dtype="f4"),
        material=material_plain_5,
    ).translate(Vector3((1.0, 0.0, 0.0))),
    Triangle(
        Vector3((-1, -0, 5), dtype="f4"),
        Vector3((1, -0, 5), dtype="f4"),
        Vector3((1, -0.8, 3), dtype="f4"),
        material=material_plain_5,
    ).translate(Vector3((1.0, 0.0, 0.0))),
...
cam.pos.z -= 2
msh = scene.meshes[0]
msh.csys.translate(Vector3((0.0, 0.0, 6.0)))
msh.csys.Rz(180)
...
if not STATIC_RENDER_ANIMATION:
    try:
        while running:
            ...
            # sp1.pos.x = x1 + 0.5 * sin(time / 3)
            sp1.pos.y = y1 + 1.2 * sin(time / 1)
            # sp1.pos.z = z1 + 0.5 * sin(time / 7)
